...
if __name__ == '__main__':
    ...
    parser.add_argument('-nr','--nrep',type=int, default=10000, help='number of repeat of one pattern before go to the next pattern in drill mode (default: 10000)')  
    #
